...
function getFooterHtml() {
  ...
  html += '    <div class="row">';
  html += '      <div class="col text-center px-0"><button class="btn btn-light text-primary" type="button"><i class="fa fa-book" style="font-size:32px;" onclick="return createHistView();"></i></button></div>';
  /*
...
function createGetAchvView(badge) {
  var contentHTML = '';
  contentHTML += '<img src="https://envose.github.io/img/reward-badge.webp" class="d-block w-100" alt="">';
