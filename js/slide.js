...
var slides = {
  ...
  'mo': {
  	0: {
  	  ...
  	  'h5': '若按這想法，聖經應該常以單數來表現上帝。<br>但是聖經卻以複數—「我們」，來表現了上帝。',
  	  'p': '',
  	},
  	1: {
  	  'title': '只有一位上帝？',
  	...
  	2: {
  	  'title': '上帝卻說了「我們」',
  	  'img': 'assets/slide_bg.jpg',
  	  'h5': '要是創造人類的創造主，只有父親上帝一位，那麼上帝應該說「我」；<br>但分明說了「我們」，證明不是只有父親上帝。',
  	  'p': '',
  	},
  	3: {
  	  'title': '為甚麼說「我們」？',
  	...
  	4: {
  	  'title': '為甚麼說「我們」？',
  	  'img': 'assets/mo_4.png',
  	  'h5': '就像打印一樣，從複本可知原件的形象',
  	  'p': '',
  	},
  	5: {
  	  'title': '為甚麼說「我們」？',
  	  'img': 'assets/mo_5.png',
  	  'h5': '複本有2個形像，告知我們原件有2個形像',
  	  'p': '',
  	},
  	6: {
  	  'title': '為甚麼說「我們」？',
  	  'img': 'assets/mo_6.png',
  	  'h5': '男人是按照了男性形像的父親上帝，女人則按照了女性形像的母親上帝<br>因為有2位上帝，所以上帝才說「我們」',
  	  'p': '',
  	},
  	7: {
  	  'title': '結論',
